...
import { authError } from '~/store/auth/action';
const Register = (props) => {
    useEffect(() => {
        props.dispatch(authError(null));
    }, []);
    ...
    if (props.error && formRef.current) {
                        ...
                        <div className="ps-form__content">
                            ...
                            <div className="form-group submit">
                                <button
                                    ...
                                    style={{
                                        backgroundColor:
                                            props.loading && '#000000',
                                    }}>
                                    Register {props.loading && <Spin />}
                                </button>
                            </div>
                        </div>
